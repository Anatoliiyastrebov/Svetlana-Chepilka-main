    ...
    questions: [
      {
        id: 'water_per_day',
        type: 'number',
        label: { ru: 'Сколько чистой воды вы пьёте в день? (в литрах, не считая чай, кофе, соки и другие напитки)', en: 'How much pure water do you drink per day? (in liters, not counting tea, coffee, juices and other drinks)' },
        icon: 'droplet',
        required: true,
        hasAdditional: false,
        placeholder: { ru: 'Например: 2', en: 'Example: 2' },
        unit: 'liters',
      },
    ],
  },
